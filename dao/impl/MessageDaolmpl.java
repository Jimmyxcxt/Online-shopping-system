...
public class MessageDaoUmpl implements MessageDao{
  ...
  public HibernateTemplate getHubernateTemplate(){
  ...
  public Message queryMessage(String username){
    ...
    "from Message m where m.username=?").setParameter(0,username),uniqueResult();
  }
}
